...
* single type Fire implements fire type interfaces
...
public class Charmander extends Pokemon implements FireType {
   ...
   /** second type of Charmander which is none. */
   ...
   */
   public Charmander() {
      super("Charmander", "Charmander", 4, FIRE_COLOR, 0.6, 8.5, 
         FIRE_TYPE, type,  BASE_ATTACK_POWER, 
   ...
   *@param type The second type of Pokemon.
   */
   protected Charmander(String species, String name, int num, 
       double ht, double wt, int baseAttackPwr, int baseDefensePwr, 
       int baseStaminaPwr, String type) {
       
      super(species, name, num, FIRE_COLOR, ht, wt, FIRE_TYPE, type, 
   ...
   */
   public String performFastAttack(Pokemon victim) {
      ...
      } else if (vType.equals("Dragon") || vType.equals("Rock") 
      ...
      s = s + "\n It makes " + (int) (damage / (victim.defensePower)) 
         + " damage!";
      return s;
   }
